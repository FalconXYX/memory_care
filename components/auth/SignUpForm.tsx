...
export default function SignUpForm() {
  ...
  return (
    <div className="w-full max-w-lg mx-auto p-0 sm:p-6 bg-white rounded-2xl shadow-2xl sm:mt-6 mt-2">
      <div className="px-6 py-8 sm:px-8">
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex justify-center items-center py-3 px-4 border border-blue-100 rounded-xl shadow-md bg-gradient-to-r from-blue-50 to-green-50 text-base font-semibold text-blue-700 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 mb-4 transition-all"
        >
        ...
        <div className="flex items-center mb-6">
          ...
          <span className="px-2 text-blue-500 bg-white">
